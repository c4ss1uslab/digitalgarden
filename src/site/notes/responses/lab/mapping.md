...
⭐ technically a [[responses/lab/dashboards\|dashboard]], but still the best example of multi-dimensional information presentation/mapping i've found: [[projects & tools/projects/lab/envisioning tech radar\|envisioning radar]].
...
**economics maps**:
⭐️ https://atlas.cid.harvard.edu/ (technically, it's a set of interactive graphs)

**argument/debate maps**:
https://www.societylibrary.org/diablo-canyon-debate

**music genres maps**:
⭐️ https://musicmap.info/
https://everynoise.com/ (technically a graph, but works like a map)
https://www.music-map.com/

**power/influence maps:**
⭐️ https://calculatingempires.net/ - a genealogy of technology and power since 1500
...
⭐️an introduction to the subject/space: https://secondrenaissance.net/intro
...
⭐ [[projects & tools/tools/lab/community archive\|community archive]]'s "[twitter strands](https://bangers.community-archive.org/best-strands)"
...
proprietary:
- aerolito's 3 waves data-viz platform (+ its predecessor OLI]
- weforum's strategic intelligence maps (https://intelligence.weforum.org/topics/)
- [[scenario mapping\|scenario mapping]]: [radiant by metaculus](https://www.metaculus.com/notebooks/42293/map-the-future-before-you-build-it/)
...
this isn't exactly mapping, but surfacing visuals/diagrams that explain any topic, a kind of visual [[topics/lab/search engine\|search engine]] - [[projects & tools/tools/lab/globe engineer\|globe engineer]]
...
mapping is different from [[references/lab/map-making tools\|map-making tools]], which are often used for 2d/3d gaming/RPG purposes.

[[mapping approaches\|mapping approaches]]: [[projects & tools/projects/design/OMNI-mapping project\|omnimapping]], [[models & frameworks/design/wardley mapping\|wardley mapping]], etc.
