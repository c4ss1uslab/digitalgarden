...
cosmoerotic humanism is a post-[[postmodern\|postmodern]] philosophical project that aims to expand our understanding of [[topics/alchemy/metaphysics\|metaphysics]], [[concepts/design/value\|value]] and the [[sacred\|sacred]], integrating insights from different fields - [[perennial philosophy\|perennial philosophy]], [[topics/alchemy/wisdom traditions\|wisdom traditions]], different [[concepts/alchemy/interior sciences\|interior]] and [[terms/sciences\|exterior sciences]] (what they call "the best of premodern, modern and postmodern thought") - into a coherent narrative of [[concepts/alchemy/self\|self]], [[life\|life]] and [[the universe\|the universe]], what they call a [[story of value\|story of value]] - and therefore, of [[concepts/alchemy/ethics\|ethics]], [[love\|love]] and [[evolution\|evolution]] - both deep enough to respond adequately to our most pressing [[concepts/design/metacrisis\|existential issues]] and broad enough to provide "a [[universal grammar of value\|universal grammar of value]] - i.e. a [shared set of first principles and first values](https://worldphilosophyreligion.substack.com/p/it-is-possible-to-make-a-partial) as a context for our diversity".

they propose that any complete (whole) philosophy presents a [[terms/cosmology\|cosmology]], an [[concepts/alchemy/epistemology\|epistemology]], an [[concepts/alchemy/ontology\|ontology]] and an [[concepts/alchemy/axiology\|axiology]], and that's what they're attempting to do with CosmoErotic Humanism as a whole.

associated with: [[zak stein\|zak stein]], [[marc gafni\|marc gafni]], [[people/references/alchemy/ken wilber\|ken wilber]]/[[responses/alchemy/integral theory\|integral theory]], [[initiatives, orgs & communities/design/the consilience project\|consilience project]], [[initiatives, orgs & communities/design/civilization research institute\|civilization research institute]].

---
#### a few powerful and elucidating quotes
...
[Love Or Die - An Early Version of a Paper by Dr. Marc Gafni](https://worldphilosophyreligion.substack.com/p/love-or-die) - an introductory and provocative short paper.

[It Is Possible to Make a Partial List of First Principles and First Values of Cosmos - Proposition 23 from the Book "First Principles and First Values](https://worldphilosophyreligion.substack.com/p/it-is-possible-to-make-a-partial) - the core of it all. the foundational set of first principles and first values they've identified across traditions, religions, philosophy and science, coming together as a "universal grammar of value". it's the center of the FPFV book. worth studying, revisiting and digesting over a long period of time.
...
[First Principles and First Values - Forty-Two Propositions on CosmoErotic Humanism, the Meta-Crisis, and the World to Come](https://amplifypublishinggroup.com/product/nonfiction/politics-and-current-affairs/first-principles-and-first-values/) - full core book, launched in 2024.
...
##### [conversations with david j. temple podcast](https://worldphilosophyreligion.substack.com/s/conversations-with-davidjtemple)
###### [value is the cure]():
...
###### zak & daniel thorson on recentering value in education
...
o convite: é uma meta-análise das filosofias, religiões, tradições de visões sobre o sagrado e o aspecto científico também da evolução, mas não de um lugar removido/objetivo, "puramente científico" (porque isso é impossível). vem de um lugar implicado, participatório, buscando reconhecer os movimentos surgindo nessa direção de integração e desenvolver linguagem comum transcontextual que possibilita falar sobre espiritualidade, sagrado, consciência, significado, valor com bem mais profundidade, rigor e amorosidade. espiritualidade não (apenas) como crença, mas como prática e constante clarificação, de modo que vire inteligência - algo que vc já tem e pode acessar, clarificar, pra entender como se desenvolver e como responder à metacrise (à intensificação da destruição e o esvaziamento da vida na terra).

pode ser overwhelming, mas serve como um recurso de profundidade e abrangência ímpar pra abrir caminho pra ir a fundo em grandes tradições espirituais e seus princípios fundamentais/cosmologias.

oferece práticas e caminhos também, como uma tradição em si. ex:

como essa inteligência espiritual se revela? a partir da clarificação do desejo -> da abertura o "olho do valor". quanto mais tá aberto, mais a sua inteligência espiritual está refinada.

então como clarificamos desejo? como abrimos o olho do valor?

- imersões
- estudo
- prática
- jornadas de prática - 8 semanas, 12 semanas, etc
	-> ver, por exemplo: [[concepts/alchemy/anthro-ontological method\|anthro-ontology]]